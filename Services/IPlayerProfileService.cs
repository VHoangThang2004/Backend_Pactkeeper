...
public interface IPlayerProfileService
{
    ...
    Task<(bool Success, string? Error)> UpdateUnitTrinketAsync(string playerId, string ownedUnitId, string? ownedTrinketId); Task<List<OwnedWeaponResultDto>> GetOwnedWeaponsByClassIdsAsync(string playerId, List<int> classIds);
